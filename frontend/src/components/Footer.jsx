		...
		<div className="w-full min-h-32  shadow-gray-950 shadow-inner flex flex-col justify-between items-start px-4 py-8 bg-slate-800 text-white">
			...
			<div className="flex items-center justify-start w-full p-4 flex-wrap">
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
					...
					<span>Jatin Rakhaulya</span>
					<span>Ghaziabad, uttarpradesh</span>
					<span>Pincode - 201016</span>
					<span>
						<Link
							to={"mailto:contact.jatinrakhaulya@gmail.com"}
							target="_blank"
							className="hover:text-blue-600 hover:underline"
						>
							contact.jatinrakhaulya@gmail.com
						</Link>
					</span>
				</div>
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
				...
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://www.linkedin.com/in/jatinRakhaulya/"
							target="_blank"
							rel="noreferrer"
						>
							LinkedIn
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://github.com/JatinRakhaulya"
							target="_blank"
							rel="noreferrer"
						>
							Github
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://instagram.com/jatin_rakhaulya/"
							target="_blank"
							rel="noreferrer"
						>
							Instagram
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="mailto:contact.jatinrakhaulya@gmail.com"
							target="_blank"
							rel="noreferrer"
						>
							E-Mail
